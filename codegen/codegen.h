...
EXTERN(int, emitComputeVariableAddress,(DList instList, SymTable lsymtab, SymTable symtab, char* varName));
...
EXTERN(void, emitProcedurePrologue,(DList instList,SymTable symtab, int index));
